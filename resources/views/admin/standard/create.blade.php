...
<div class="page-content-wrapper">
  ...
  <div class="page-content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form method="post" action="{{url('/')}}/admin/standard/store" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <div class="col-md-6">
              <label class="form-label">Standard Title</label>
              <input class="form-control mb-3" type="text" name="standardName" value="{{old('standardName')}}" placeholder="Standard Name" value="{{old('standardName')}}">
            ...
            <div class="col-md-6">
              ...
              <input class="form-control mb-3" type="text" name="standardCode" value="{{old('standardCode')}}" placeholder="Standard Code" >
             ...
             <textarea class="form-control" id="description" placeholder="Enter the Description" name="description">{{old('standardCode')}}</textarea>
