...
<div class="page-content-wrapper">
  ...
  <div class="page-content">
      ...
      <div class="ps-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 p-0 align-items-center">
            ...
            <li class="breadcrumb-item active" aria-current="page">Add Sub Course</li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form method="post" action="{{url('/')}}/admin/sub-course/store" enctype="multipart/form-data">
          @csrf
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <input class="form-control mb-3" type="text" name="subCourseTitle" placeholder="Sub Course Title" value="{{old('subCourseTitle')}}">
