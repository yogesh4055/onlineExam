...
<div class="page-content-wrapper">
  ...
  <div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
      ...
      <div class="ms-auto">
        <div class="btn-group">
          <a href="{{url('/')}}/admin/course/create" type="button" class="btn btn-outline-primary"> <ion-icon name='add'></ion-icon>Add </a>
        </div>
      </div>
    </div>
    <!--end breadcrumb-->
  ...
  <script type="text/javascript">
    ...
    var temp_url    = '<?php echo url("/");?>/admin/course/get_records';
