        ...
        <form method="post" action="{{url('/')}}/admin/banners/store" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <input class="form-control mb-3" type="text" name="social_link" placeholder="Social Link" >
            ...
            <div class="col-md-6">
              ...
              <input class="form-control mb-3" type="text" name="social_name" placeholder="Social Name" >
            ...
            <div class="col-md-6">
              ...
              <input class="form-control mb-3" type="text" name="social_icon" placeholder="Social Icon" >
            ...
            <div class="mb-3">
              <div class="cart-img text-center text-lg-start">
                <img id="image_preview" src="{{ url('/')}}/assets/images/no-image-found.png" alt="" width="130">
              </div>
