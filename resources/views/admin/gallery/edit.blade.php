...
<div class="page-content-wrapper">
  ...
  <div class="page-content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form method="post" action="{{url('/')}}/admin/gallery/update/{{base64_encode($arrdata['id'])}}" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <div class="col-md-12">
              <label class="form-label">News Title</label>
              <input class="form-control mb-3" type="text" name="title" value="{{$arrdata['title']}}" placeholder="News Title" >
              @if($errors->has('title'))
            ...
            <div class="col-md-6">
              <label class="form-label">Industry</label>
                <select class="form-select mb-3" name="industry_id" aria-label="Default select example">
                  ...
                  <option value="{{$industry['id']}}"  @if($industry['id']==$arrdata['industry_id']) selected="" @endif>{{$industry['name']}}</option>
                  @endforeach
                </select>
            ...
            <div class="col-md-12">
             ...
             <div class="col-md-12">
              ...
              <input class="form-control mb-3" type="text" name="meta_keywords" value="{{$arrdata['meta_keywords']}}" placeholder="Meta Keyword" >
