...
<div class="page-content-wrapper">
  ...
  <div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
      <div class="breadcrumb-title pe-3">Exam Question</div>
      <div class="ps-3">
      ...
      <div class="ms-auto">
        <div class="btn-group">
          <a href="{{url('/')}}/admin/exam-question/create" type="button" class="btn btn-outline-primary"> <ion-icon name='add'></ion-icon>Add </a>
        </div>
      </div>
    </div>
    <!--end breadcrumb-->
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center gap-3 fs-6">
                  <a href="{{url('/')}}/admin/exam-question/edit/{{base64_encode($row->examQuestionId)}}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom"
                  title="" data-bs-original-title="Edit info" aria-label="Edit">
                  <ion-icon name="pencil-sharp"></ion-icon>
                  </a>
                  <a href="{{url('/')}}/admin/exam-question/delete/{{base64_encode($row->examQuestionId)}}" class="text-danger" data-bs-toggle="tooltip" data-bs-placement="bottom"
 ...
 <script type="text/javascript">
    ...
    var temp_url    = '<?php echo url("/");?>/admin/exam-question/get_records';
